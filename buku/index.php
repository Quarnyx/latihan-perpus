<?php
$page_title='Data Buku'; $current_menu='buku';
...
<div class="card mb-3"><div class="card-body py-2">
  <form method="GET" class="d-flex gap-2">
    <input type="text" name="cari" class="form-control" placeholder="Cari nama buku, kode, atau kategori..." value="<?=htmlspecialchars($cari)?>">
...
<div class="card"><div class="card-body p-0"><div class="table-responsive">
  <table class="table table-hover mb-0">
    <thead><tr><th>No</th><th>Kode</th><th>Nama Buku</th><th>Penulis</th><th>Penerbit</th><th>Kategori</th><th>Stok</th><th>Tahun</th><th>Aksi</th></tr></thead>
    <tbody>
    ...
    <tr>
      ...
      <td>
        ...
        <a href="hapus.php?id=<?=$r['id']?>" class="btn btn-sm btn-danger" onclick="return confirm('Yakin hapus buku ini?')"><i class="bi bi-trash"></i></a>
      </td>
    </tr>
    <?php endwhile; else: ?>
    <tr><td colspan="9" class="text-center py-3 text-muted"><?=$cari?"Buku tidak ditemukan.":"Belum ada data buku."?></td></tr>
    <?php endif; ?>
    </tbody>
  </table>
</div></div></div>
