    ...
    <div class="card text-white bg-primary h-100">
      <div class="card-body">
        <div class="d-flex justify-content-between align-items-center">
          <div>
            <p class="mb-1 small opacity-75">Total Anggota</p>
  ...
  <div class="col-6 col-md-3">
    <div class="card text-white bg-success h-100">
      <div class="card-body">
        <div class="d-flex justify-content-between align-items-center">
          <div>
            <p class="mb-1 small opacity-75">Total Buku</p>
  ...
  <div class="col-6 col-md-3">
    <div class="card text-white bg-warning h-100">
      <div class="card-body">
        <div class="d-flex justify-content-between align-items-center">
          <div>
            <p class="mb-1 small opacity-75">Sedang Dipinjam</p>
  ...
  <div class="col-6 col-md-3">
    <div class="card text-white bg-info h-100">
      <div class="card-body">
        <div class="d-flex justify-content-between align-items-center">
          <div>
            <p class="mb-1 small opacity-75">Total Pengembalian</p>
            <h2 class="mb-0 fw-bold"><?= $total_kembali ?></h2>
          </div>
...
<div class="row g-3 mb-4">
  <div class="col-6 col-md-3">
    <a href="anggota/index.php" class="text-decoration-none">
      <div class="card h-100 text-center p-3 border-2 border-primary" style="transition:.2s"
  ...
  <div class="col-6 col-md-3">
    <a href="peminjaman/index.php" class="text-decoration-none">
      <div class="card h-100 text-center p-3 border-2 border-warning" style="transition:.2s"
        onmouseover="this.style.transform='translateY(-4px)'" onmouseout="this.style.transform=''">
  ...
  <div class="col-6 col-md-3">
    <a href="pengembalian/index.php" class="text-decoration-none">
      <div class="card h-100 text-center p-3 border-2 border-info" style="transition:.2s"
        onmouseover="this.style.transform='translateY(-4px)'" onmouseout="this.style.transform=''">
  ...
  <div class="col-6 col-md-3">
    <a href="buku/index.php" class="text-decoration-none">
      <div class="card h-100 text-center p-3 border-2 border-success" style="transition:.2s"
        onmouseover="this.style.transform='translateY(-4px)'" onmouseout="this.style.transform=''">
      ...
      <table class="table table-hover mb-0">
        ...
        <tbody>
          ...
          if (mysqli_num_rows($res) > 0):
            ...
            <?php endwhile; else: ?>
            <tr>
              <td colspan="6" class="text-center py-3 text-muted">Tidak ada peminjaman aktif.</td>
            </tr>
          <?php endif; ?>
        </tbody>
      </table>
