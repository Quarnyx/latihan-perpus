...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
  ...
  $sql = "UPDATE supplier SET kode_supplier='$kode',nama_supplier='$nama' WHERE id=$id";
...
<div class="page-header d-flex justify-content-between align-items-center">
  <h4 class="mb-0"><i class="bi bi-truck me-2"></i>Edit Data Supplier</h4>
    ...
    <form method="POST">
      <div class="row g-3">
        <div class="col-md-6"><label class="form-label fw-semibold">Kode *</label><input type="text"
            name="kode_supplier" class="form-control" value="<?= $data['kode_supplier'] ?>" required></div>
        <div class="col-md-6"><label class="form-label fw-semibold">Nama Supplier *</label><input type="text"
            name="nama_supplier" class="form-control" value="<?= htmlspecialchars($data['nama_supplier']) ?>" required>
        </div>
      </div>
